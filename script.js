 (function() {
        ...
        const responseMap = {
           ...
           'How is result calculated' : 'The following terminologies and abbreviations are commonly used in the computation of Grade Point Average (GPA)     .(a) Total Load Units (TLU): This is the total number of course units carried by a student in a particular semester. It is the summation of the load units on all courses carried during the semester. For example, a student who is taking 6 courses of 3 units each has a TLU of 18 for that semester.                                                         (b) Cumulative Load Units (CLU): This is the summation of Total Load Units over all the semesters from the beginning to date. A student who is prone to repeating courses will finish (if he does not drop out) with a higher CLU than his non-repeating colleagues, and will most likely require a longer time to complete requirements for the award of degree.                                                                              (c) Total Credit Points (TCP): This is the sum of the products of course units and rating in each course, for the entire semester. For example, consider a student who took 5 courses of 3 units each. Suppose the grades he obtained in the four courses were A, B, C, D and E. The TCP of this student is obtained as (3 x 5.0) + (3 x 4.0) + (3 x 3.0) + (3 x 2.0) + (3 x 1.0) = 15.00 + 12.0 + 9.0 + 6.0 + 3.0 = 45.0.                  (d) Cumulative Credit Point (CCP): This is the summation of Total Credit Points over all semesters from the beginning to date.                                             (e) Grade Point Average (GPA): This is the Total Credit Points (TCP) divided by the Total Load Unit (TLU). For example, consider the student’s scores referred to above. His/her TCP is 45.0 and his TLU is 15 (i.e. 5 courses at 3 units each for the semester). His GPA is therefore 45/15 = 3.00. The higher possible GPA that can be earned is 5.0 and that is when a student has earned a grade of “A” in every course during the semester. The lowest GPA obtained is 0.00.                                 (f) Cumulative Grade Point Average (CGPA): This is not the summation of GPA’s for the semesters. Rather, is the summation of TCP for all semesters to date, divided by the summation of TLU for the said semesters. In effect, CGPA = CCP/CLU.     ',

           'What is futa grading system' : '70-100 = A with a grade point of 5.   60 – 69=B with a grade point of 4.   50 – 59 = C with a grade point of 3.   45 – 49 = D with a grade point of 2 .  40 – 44 = E with a grade point of 1.  43 – 0 = F with a grade point of 0',

           'What are futa Classes of Degree' :'First Class	4.50 - 5.00 2nd Class(UpperDivision)	3.50 - 4.49 2nd Class (Lower Division)	2.40 - 3.49 3rd Class	1.50 - 2.39 Pass	1.00 - 1.49', 
